...
function App() {
  ...
  return (<form onSubmit={handleSubmit} className="container mx-auto p-6 max-w-xl bg-white shadow-md rounded-xl">
    ...
    <div className="grid gap-6">
      ...
      <div>
        <Label htmlFor="name" className="block font-medium text-primary-400 mb-2">
          Name
        </Label>
        <Input type="text" id="name" placeholder="Character Name" value={name} onChange={(e) => setName(e.target.value)} className=" text-primary-500 font-semibold text-opacity-100 w-full rounded-xl border-primary-300 shadow-sm
      ...
      <div>
        <Label htmlFor="age" className="block font-medium text-primary-400 mb-2">
          Age
        </Label>
        <Input type="number" id="age" placeholder="Age" value={age} onChange={(e) => setAge(e.target.value)} className=" text-primary-500 font-semibold text-opacity-100 w-full rounded-xl border-primary-300 shadow-sm
      focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 border-2
      placeholder:text-primary-500" />
      </div>
      {/* Select field for the character's gender */}
      <div>
        <Label htmlFor="gender" className="block font-medium text-primary-400 mb-2">
          Gender
        </Label>
        <Select value={gender} onValueChange={setGender}>
          <SelectTrigger className="w-full rounded-xl border-primary-300 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 border-2 text-primary-500">
      ...
      <div>
        <Label htmlFor="occupation" className="block font-medium text-primary-400 mb-2">
          Occupation
        </Label>
        <Input type="text" id="occupation" placeholder="Occupation" value={occupation} onChange={(e) =>
          setOccupation(e.target.value)} className=" text-primary-500 font-semibold text-opacity-100 w-full rounded-xl border-primary-300 shadow-sm
      focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 border-2
      placeholder:text-primary-500" />
      </div>
      {/* Textarea for the character's personality */}
      <div>
        <Label htmlFor="personality" className="block font-medium text-primary-400 mb-2">
          Personality
        </Label>
      ...
      <div>
        ...
        {hobbies.map((hobby) => (
          <div key={hobby.id} className="flex space-x-2 mb-2 items-center">
            <Input type="text" placeholder="Hobby" value={hobby.value} onChange={(e) =>
              handleHobbyChange(
        ...
        <Button type="button" onClick={handleAddHobby} className="mt-2 px-4 py-2 bg-primary-300 text-white rounded-xl hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 w-full">
          Add Hobby
        </Button>
      </div>
      {/* Textarea for the character's story */}
      <div>
        <Label htmlFor="story" className="block font-medium text-primary-400 mb-2">
          Story
        </Label>
      ...
      <div>
        <Label htmlFor="relation" className="block font-medium text-primary-400 mb-2">
          Relation to You
        </Label>
      ...
      <div>
        ...
        {relations.map((relation) => (
          <div key={relation.id} className="flex gap-2 mb-2 items-center w-auto">
            ...
            <Input type="text" placeholder="Character" value={relation.character} onChange={(e) =>
            ...
            <Input type="text" placeholder="Relation" value={relation.relation} onChange={(e) =>
              handleRelationChange(
                relations.findIndex((r) => r.id === relation.id),
                "relation",
                e.target.value,
        ...
        <Button type="button" onClick={handleAddRelation} className="mt-2 px-4 py-2 bg-primary-300 text-white rounded-xl hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 w-full">
          Add Relation
        </Button>
      </div>
    </div>
    {/* Submit button for the form */}
    <Button type="submit" className="mt-6 px-4 py-2 bg-primary-300 text-white rounded-xl hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 w-full">
      Submit
    </Button>
    {/* Button to download the saved data */}
    <Button type="button" onClick={handleDownload} className="mt-2 px-4 py-2 bg-primary-300 text-white rounded-xl hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 w-full">
      Download
    </Button>
  </form>);
